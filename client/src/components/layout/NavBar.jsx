...
const NavBar = ({ avatar, username, notifications }) => {
    ...
    return (
        <div className="navbar bg-base-100/90 backdrop-blur-md sticky top-4 z-50 w-[95%] mx-auto rounded-2xl shadow-lg grid grid-cols-2 lg:grid-cols-4 auto-cols-max mb-5 border border-base-200 transition-all duration-300">
            ...
            <div className="navbar-start w-[unset] lg:col-span-1">
                ...
                <div className="dropdown static">
                    ...
                    <ul
                        ...
                        <li><NavLink to='/blogs' className='py-4 flex items-center'><span className="text-xl text-primary"><HiNewspaper /></span>Blogs</NavLink></li>
                        ...
                        <li><NavLink to='/jobs' className='py-4 flex items-center'><span className="text-xl text-primary"><GiSuitcase /></span>Jobs</NavLink></li>
                    </ul>
                </div>
            ...
            <div className="navbar-center hidden lg:flex w-[unset] justify-center lg:col-span-2">
                <ul className="menu menu-horizontal px-1">
                    ...
                    <li><NavLink to='/blogs' className="flex items-center"><span className="text-xl text-primary"><HiNewspaper /></span>Blogs</NavLink></li>
                    <li><NavLink to='/network' className="flex items-center"><span className="text-xl text-primary"><IoMdPeople /></span>Network</NavLink></li>
                    <li><NavLink to='/jobs' className="flex items-center"><span className="text-xl text-primary"><GiSuitcase /></span>Jobs</NavLink></li>
                </ul>
            </div>
                ...
                <div className="dropdown dropdown-end">
                    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                        <div className="w-10 rounded-full">
                            <img
                                alt="Profile"
                                src={avatar || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTgD14vQ6I-UBiHTcwxZYnpSfLFJ2fclwS2A&s"}
                            />
                        </div>
                    </div>
                    <ul
